...
const { get_slot, create_slot_by_weekdays, mark_holiday, deleteSlot, block_slot, create_single_slot, un_block_slot, unmark_holiday } = require("../controllers/SlotController");
...
router.post('/unmark-holiday', Auth, unmark_holiday);
